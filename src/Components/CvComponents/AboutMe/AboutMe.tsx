...
const AboutMe = () => {
    return (
        <CenteredContainter>
            <ScrollUp message="Inicio" icon={<TiHome className={`${SizeControlsIcons} rotate-90`} />}/>
            ...
            <ScrollDown message="Habilidades" icon={<GiSkills className={`${SizeControlsIcons} -rotate-90`}/>}/>
        </CenteredContainter>
    )
};
