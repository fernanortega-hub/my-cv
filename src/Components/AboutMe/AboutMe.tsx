...
const AboutMe = () => {
    return (
        <div className="w-full h-screen p-6 flex flex-col justify-center items-center space-y-3 relative">
            ...
            <span className="text-xl font-semibold text-secondaryColorLight md:text-2xl"> {`${`Sobre mi...`}`} </span>
            <p className="text-center text-[1.1rem] md:text-xl"> Actualmente soy estudiante de Ingenieria Informática en la Universidad Centroamericana José Simeón Cañas. Soy desarrollador
